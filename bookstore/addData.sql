...
INSERT INTO addresses (adressId, zip, state, city, street)
VALUES 
...
INSERT INTO orders (orderId, creationDate, orderStatus, shippingAddressId, billingAddressId, creditId, employeeId, customerId)
VALUES
(1, '2019-11-02', 'Shipped', 1, 1, 1, 1),
(2, '2019-11-03', 'Shipped', 2, 2, 2, 2),
(3, '2019-11-04', 'Pending', 3, 3, 3, 3);
